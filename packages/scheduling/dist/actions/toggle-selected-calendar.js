    ...
    run: async (args) => {
        ...
        if (args.include) {
            ...
            await getDb()
                ...
                .where(and(eq(schema.selectedCalendars.credentialId, args.credentialId), eq(schema.selectedCalendars.externalId, args.externalId)));
        }
        return { ok: true };
    },
});
//# sourceMappingURL=toggle-selected-calendar.js.map
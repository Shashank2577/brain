...
export default defineAction({
    ...
    run: async (args) => {
        ...
        if (!provider.startOAuth) {
            throw badRequest(`Video provider ${args.kind} does not support OAuth — install it with 'install-conferencing-app' instead`);
        }
...
//# sourceMappingURL=connect-video.js.map
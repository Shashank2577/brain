...
export default defineAction({
    description: "List event types visible to the current user — owned, shared, org-visible, or scoped to a team the user is a member of",
    schema: z.object({
...
//# sourceMappingURL=list-event-types.js.map
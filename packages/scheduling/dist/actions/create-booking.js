...
import { z } from "zod";
import { getEventTypeById, getEventTypeBySlug, } from "../server/event-types-repo.js";
import { createBooking } from "../server/booking-service.js";
import { currentOrgId } from "./_helpers.js";
export default defineAction({
    description: "Create a booking. Either pass eventTypeId, or (ownerEmail|teamId)+slug.",
    schema: z.object({
    ...
    run: async (args) => {
        ...
        if (!hostEmail)
            throw new Error("Cannot resolve host for booking");
        return {

...
import { assignRoundRobin } from "../core/round-robin.js";
export default defineAction({
    description: "Select the next host for a round-robin event type based on recent booking load",
    schema: z.object({
    ...
    run: async (args) => {
        ...
        for (const h of hosts) {
            metrics.set(h.userEmail, {
                recentBookingCount: await countBookingsByHostInRange(h.userEmail, from, to),
                noShowRate: 0,
            });
        }
...
//# sourceMappingURL=assign-round-robin-host.js.map
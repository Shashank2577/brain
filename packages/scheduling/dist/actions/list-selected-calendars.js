...
export default defineAction({
    description: "List all calendars a credential has access to, with selected flag",
    ...
    run: async (args) => {
        ...
        if (!provider)
            throw new Error(`No provider for ${cred[0].type}`);
        ...
        const selectedSet = new Set(selected.map((r) => r.externalId));
...
//# sourceMappingURL=list-selected-calendars.js.map
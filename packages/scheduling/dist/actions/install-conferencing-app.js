...
export default defineAction({
    description: "Install a conferencing app (zero-OAuth apps like built-in video register immediately; OAuth apps start their flow)",
    schema: z.object({
...
//# sourceMappingURL=install-conferencing-app.js.map
 ...
 */
export declare const scheduleAvailability: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    name: "schedule_availability";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            name: "id";
            tableName: "schedule_availability";
            dataType: "string";
            columnType: "SQLiteText";
            data: string;
            driverParam: string;
 ...
 */
export declare const dateOverrides: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    name: "date_overrides";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/sqlite-core").SQLiteColumn<{
        ...
        intervals: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            name: "intervals";
            tableName: "date_overrides";
            dataType: "string";
            columnType: "SQLiteText";
...
export declare const travelSchedules: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    name: "travel_schedules";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            name: "id";
            tableName: "travel_schedules";
            dataType: "string";
            columnType: "SQLiteText";
            data: string;
            driverParam: string;
...
export declare const outOfOfficeEntries: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    name: "out_of_office_entries";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            name: "id";
            tableName: "out_of_office_entries";
            dataType: "string";
            columnType: "SQLiteText";
            data: string;
            driverParam: string;
        ...
        redirectUserEmail: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            name: "redirect_user_email";
            tableName: "out_of_office_entries";
            dataType: "string";
            columnType: "SQLiteText";
            data: string;
...
export declare const scheduleShares: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    name: string;
    schema: undefined;
    columns: {
        id: import("drizzle-orm/sqlite-core").SQLiteColumn<{

 ...
 */
export type SchedulingType = "personal" | "collective" | "round-robin" | "managed";
export type BookingStatus = "pending" | "confirmed" | "cancelled" | "rejected" | "rescheduled";
export type LocationKind = "builtin-video" | "zoom" | "google-meet" | "teams" | "phone" | "in-person" | "custom-link" | "attendee-phone" | "organizer-phone" | "attendee-choice";
...
export interface CustomField {
    id: string;
    type: "text" | "textarea" | "number" | "email" | "phone" | "select" | "multiselect" | "boolean" | "radio";
    label: string;
    placeholder?: string;
    required: boolean;
    options?: string[];
...
export type WorkflowTrigger = "new-booking" | "before-event" | "after-event" | "reschedule" | "cancellation" | "no-show";
export type WorkflowStepAction = "email-host" | "email-attendee" | "email-address" | "sms-attendee" | "sms-host" | "sms-number" | "webhook";
...
export type RoutingFormFieldType = "text" | "email" | "phone" | "number" | "select" | "multi";
...
export type RoundRobinStrategy = "lowest-recent-bookings" | "weighted" | "calibrated";

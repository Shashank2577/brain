 ...
 * the rest.
 */
export async function refreshExpiringGoogleTokens(opts = {}) {
    ...
    for (const acct of accounts) {
        ...
        try {
            ...
            await saveOAuthTokens("google", acct.accountId, merged);
        }
        catch (err) {
            ...
            console.warn(`[google-refresh] refresh failed for ${acct.accountId}:`, err.message);
        }
    }
}
let _started = false;
 ...
 */
export function startGoogleTokenRefreshLoop(opts = {}) {
    if (_started)
        return;
    _started = true;
...
//# sourceMappingURL=google-refresh.js.map
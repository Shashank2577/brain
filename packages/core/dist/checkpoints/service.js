...
export function getChangedFileNames(cwd) {
    try {
        ...
        const untracked = execFileSync("git", ["ls-files", "--others", "--exclude-standard"], { cwd, stdio: "pipe", timeout: TIMEOUT, encoding: "utf-8" }).trim();

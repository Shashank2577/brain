 ...
 */
import { engineToolsToAnthropic, engineMessagesToAnthropic, anthropicContentToEngine, anthropicChunkToEngineEvents, } from "./translate-anthropic.js";
...
export const ANTHROPIC_SUPPORTED_MODELS = ANTHROPIC_MODEL_CONFIG.supportedModels;
...
class AnthropicEngine {
    ...
    async *stream(opts) {
        ...
        const systemBlocks = [{ type: "text", text: opts.systemPrompt }];
        if (cacheEnabled) {
 ...
 */
export function createAnthropicEngine(config = {}) {
...
//# sourceMappingURL=anthropic-engine.js.map
...
const FRAMEWORK_DEFAULT_BUILDER_OPENAI_MODEL = builderGatewayModelId(FRAMEWORK_DEFAULT_OPENAI_MODEL);
const FRAMEWORK_DEFAULT_OPENROUTER_MODEL = openRouterModelId("openai", FRAMEWORK_DEFAULT_OPENAI_MODEL);

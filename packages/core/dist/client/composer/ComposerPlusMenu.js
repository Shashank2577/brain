...
function UploadOnlyAttachButton() {
    return (_jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx("span", { className: "inline-flex shrink-0", children: _jsx(ComposerPrimitive.AddAttachment, { asChild: true, children: _jsx("button", { type: "button", className: "shrink-0 flex h-7 w-7 cursor-pointer items-center justify-center rounded-md text-muted-foreground hover:text-foreground hover:bg-accent/50", "aria-label": "Upload", children: _jsx(IconPlus, { className: "h-4 w-4" }) }) }) }) }), _jsx(TooltipContent, { children: "Upload" })] }));
}

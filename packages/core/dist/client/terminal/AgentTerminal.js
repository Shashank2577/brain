...
export function formatWebSocketHostname(hostname) {
    return hostname.includes(":") && !hostname.startsWith("[")
        ? `[${hostname}]`
        : hostname;
}
export function AgentTerminal({ command, flags, wsUrl: wsUrlProp, hideInFrame = true, theme, fontSize = 12, className, style, onConnectionChange, onAgentRunningChange, }) {
    ...
    return (_jsx("div", { ref: termRef, className: className, style: {
            width: "100%",
            height: "100%",
            padding: "4px 12px",
            position: "relative",

...
export const tool = {
    ...
    parameters: {
        ...
        properties: {
            engine: {
                type: "string",
                description: 'Engine name (e.g. "anthropic", "ai-sdk:openai", "ai-sdk:google"). Use manage-agent-engine with action="list" to see all options.',
            },
            model: {
                type: "string",
...
//# sourceMappingURL=set-agent-engine.js.map
...
export const tool = {
    description: "Test an agent engine by sending a trivial prompt and measuring latency. Useful for verifying API keys and connectivity before switching engines.",
    parameters: {
        type: "object",
        properties: {
            engine: {
                type: "string",
                description: 'Engine name to test (e.g. "anthropic", "ai-sdk:openai"). Defaults to "anthropic".',
            },
            model: {
                type: "string",
                description: "Model to use for the test. Defaults to the engine's default model.",
            },
        },
        required: [],
    },
...
export async function run(args) {
    ...
    try {
        const engine = entry.create({
            apiKey: entry.requiredEnvVars.length > 0
...
//# sourceMappingURL=test-agent-engine.js.map
...
export interface PlatformAdapter {
     ...
     */
    postProcessingPlaceholder?(incoming: IncomingMessage): Promise<{
        placeholderRef: string;
    } | null>;
    /**
     ...
     */
    sendMessageToTarget?(message: OutgoingMessage, target: OutboundTarget): Promise<void>;
    /**
     ...
     */
    formatAgentResponse(text: string, opts?: {
        threadDeepLinkUrl?: string;
    }): OutgoingMessage;

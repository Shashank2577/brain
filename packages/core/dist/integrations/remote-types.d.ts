export type RemoteCommandKind = "create-run" | "list-runs" | "get-run" | "append-followup" | "approve" | "deny" | "stop" | "status";
export type RemoteCommandStatus = "pending" | "claimed" | "running" | "completed" | "failed";

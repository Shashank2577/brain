...
export async function transcribeWithBuilder(opts) {
    ...
    if (opts.instructions)
        params.set("instructions", opts.instructions);
    ...
    if (res.status === 402) {
        throw new Error("Builder transcription credits exhausted. Upgrade your Builder.io plan or configure another supported fallback.");
    }
    if (!res.ok) {

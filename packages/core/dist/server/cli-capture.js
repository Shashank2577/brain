    ...
    process.stdout.write = ((chunk, ...rest) => {
        ...
        if (store) {
            if (typeof chunk === "string") {
                ...
                store.logs.push(chunk.toString());
            }
 ...
 */
export async function captureCliOutput(fn, options = {}) {
 ...
 */
export function appendCapturedLog(text) {
    const store = captureStore.getStore();
    if (store)
        store.logs.push(text);
}
//# sourceMappingURL=cli-capture.js.map
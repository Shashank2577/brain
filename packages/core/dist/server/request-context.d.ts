 ...
 * path.
 */
export declare function addRequestContextObserver(observer: RequestContextObserver): () => void;
/**
 ...
 * `AGENT_USER_NAME`.
 */
export declare function getRequestUserName(): string | undefined;
/**
 ...
 */
export declare function getCredentialContext(): {
    userEmail: string;
    orgId: string | null;
} | null;
/**
 ...
 */
export declare function getRequestRunContext(): RequestRunContext | undefined;
/**
 ...
 */
export declare function ensureRequestRunContext(): RequestRunContext | undefined;
export {};

...
export async function listHubServers() {
    ...
    if (process.env.NODE_ENV === "production" &&
        ...
        if (!_warnedMultiOrg) {
            ...
            console.warn(`[mcp-client/hub] Refusing to serve hub responses: ${seenOrgs.size} distinct orgs detected ` +
...
export function mountMcpHubRoutes(nitroApp) {
    const mountedApps = (globalThis.__agentNativeMcpHubMountedApps ??= new WeakSet());

 ...
 */
export function registerFileUploadProvider(provider) {
    providers.set(provider.id, provider);
}
export function unregisterFileUploadProvider(id) {
    providers.delete(id);
}
export function listFileUploadProviders() {
 ...
 * SQL fallback.
 */
export function getActiveFileUploadProvider() {

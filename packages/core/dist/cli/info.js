...
export function runInfo(pkgName) {
    if (!pkgName) {
    ...
    if (fs.existsSync(ejectDoc)) {
        ...
        console.log("  (A full `agent-native eject` command is planned for a future release.)");
    }
}
function resolvePackageJson(pkgName, from) {

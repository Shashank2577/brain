...
export function workspacifyApp(opts) {
    ...
    if (fs.existsSync(agentsPath)) {
        try {
            ...
            content = content
                .replace("The terminal cwd is the framework root. Always `cd` to this template's root before running any action:", `The terminal cwd is the workspace root. Always \`cd\` to this app's root before running any action:`)
...
//# sourceMappingURL=workspacify.js.map
...
async function discoverPluginExports(packageDir) {
    ...
    for (const [slot, names] of Object.entries(slotExportNames)) {
 ...
 */
export async function getWorkspaceCoreExports(cwd = process.cwd()) {
...
export function _resetWorkspaceCoreCache() {
    cache = undefined;
}
//# sourceMappingURL=workspace-core.js.map
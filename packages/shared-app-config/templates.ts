...
export const TEMPLATES: TemplateMeta[] = [
  ...
  },
  {
    name: "meetings",
    label: "Meetings",
    hint: "Granola-style meeting lifecycle — prep notes, live transcript, AI summary, follow-ups fanned out to tasks",
    icon: "UsersGroup",
    color: "#16A34A",
    colorRgb: "22 163 74",
    devPort: 8101,
    prodUrl: "https://meetings.agent-native.com",
    defaultMode: "prod",
    core: true,
  },
  {
  ...
  },
  {
    name: "tasks",
    label: "Tasks",
    hint: "Lightweight todo — capture, complete, link tasks to notes",
    icon: "Checkbox",
    color: "#0EA5E9",
    colorRgb: "14 165 233",
    devPort: 8103,
  ...
  },
  {
    name: "notes",
    label: "Notes",
    hint: "Capture, search, and share quick text snippets with the agent",
    icon: "FileText",
    color: "#10B981",
    colorRgb: "16 185 129",
    devPort: 8102,
    prodUrl: "https://notes.agent-native.com",
    defaultMode: "prod",
    core: true,
  },
  {
    name: "crm",
    label: "CRM",
    hint: "Contacts, deals, and activity history — composes mail and calendar so the agent can run a real pipeline",
    icon: "AddressBook",
    color: "#2563EB",
    colorRgb: "37 99 235",
    devPort: 8104,

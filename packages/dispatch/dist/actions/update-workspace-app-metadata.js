...
export default defineAction({
    description: "Update the human-editable display name and description Dispatch uses for a workspace app. These details are also used as connected-agent/A2A context.",
    schema: z.object({
        appId: z
            .string()
            .max(64)
...
//# sourceMappingURL=update-workspace-app-metadata.js.map
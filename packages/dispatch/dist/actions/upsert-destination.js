...
export default defineAction({
    description: "Create or update a saved messaging destination for proactive Slack, Telegram, or email sends.",
    schema: z.object({
        ...
        destination: z
            .string()
            .describe("Channel ID, chat ID, email address, or other platform destination id"),
        threadRef: z
            .string()
            .optional()
...
//# sourceMappingURL=upsert-destination.js.map
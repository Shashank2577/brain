...
import { z } from "zod";
import { enqueueRemoteCodeCommand, } from "../server/lib/dispatch-remote-commands.js";
...
export default defineAction({
    description: "Route a command to the remote Agent-Native Code host through the integration relay.",
    schema: z.object({
...
//# sourceMappingURL=send-code-agent-remote-command.js.map
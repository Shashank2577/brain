...
export default defineAction({
    ...
    schema: z.object({
        ...
        description: z
            ...
            .optional()
            .nullable()
            .describe("Concise AI-generated description of the app based on the user's prompt. Dispatch saves this while the app is being created."),
        secretIds: z
            .array(z.string())
            .max(100)
            .optional()
        ...
        resourceIds: z
            ...
            .max(100)
            .optional()
            .describe("Dispatch workspace resource IDs or knowledge packs to grant to the app"),
    }),
    run: async (args) => startWorkspaceAppCreation(args),
});
//# sourceMappingURL=start-workspace-app-creation.js.map
...
export default defineAction({
    description: "Get a full read-only debug snapshot for an agent chat thread, including persisted messages, raw thread_data, run events, traces, feedback, evals, and checkpoints when present.",
    schema: z.object({
        sourceId: z
            .string()
            .default("current")
...
//# sourceMappingURL=get-agent-thread-debug.js.map
...
export default defineAction({
    description: "Grant several selected workspace resources or knowledge packs to an app, skipping existing active grants.",
    schema: z.object({
...
//# sourceMappingURL=grant-workspace-resources-to-app.js.map
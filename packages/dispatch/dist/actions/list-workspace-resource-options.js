...
export default defineAction({
    description: "List lightweight workspace resource options for selectors, without returning full content.",
    schema: z.object({
        kind: z
...
//# sourceMappingURL=list-workspace-resource-options.js.map
...
import { getAgentThreadDebug, listThreadDebugSources, searchAgentThreads, } from "../server/lib/thread-debug-store.js";
...
function stripUndefined(args) {
    return Object.fromEntries(Object.entries(args).filter(([, value]) => value !== undefined));
}
export default defineAction({
    description: "See what the user is currently looking at in the dispatch UI, including navigation state and a compact operational summary.",
    schema: z.object({}),
    http: false,
    run: async () => {
        ...
        if (navigation?.view === "overview" ||
            ...
            if (navigation?.view === "apps") {
                screen.workspaceAppResources = await Promise.all(workspaceApps
        ...
        if (navigation?.view === "workspace" || navigation?.view === "new-app") {
            ...
            screen.workspaceResourceEffectiveContext = {
                ...
                description: "Preview workspace -> organization/app -> personal precedence for a resource path and optional app/user. All-app resources are inherited at runtime; selected resources are app-specific exceptions.",
            };
            screen.workspaceResourceImpactPreview = {
                action: "preview-workspace-resource-change",
                description: "Preview All-app reach, overrides, and approval behavior before creating, updating, or deleting a workspace resource.",
            };
        }
...
//# sourceMappingURL=view-screen.js.map
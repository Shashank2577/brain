...
export default defineAction({
    description: "List workspace resource grants — which apps have access to which shared skills, instructions, and agents.",
    schema: z.object({
...
//# sourceMappingURL=list-workspace-resource-grants.js.map
...
export default defineAction({
    description: "Grant multiple Dispatch vault secrets to a workspace app. Existing active grants are skipped.",
    http: { method: "POST" },
    schema: z.object({
        appId: z
            .string()
...
//# sourceMappingURL=grant-vault-secrets-to-app.js.map
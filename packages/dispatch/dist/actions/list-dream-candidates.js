...
export default defineAction({
    description: "List recent agent threads worth reviewing in a Dispatch dream pass, scored from grounded signals like corrections, failures, tool errors, feedback, evals, and satisfaction.",
    schema: z.object({
        sourceId: z
            .string()
            .default("current")
...
//# sourceMappingURL=list-dream-candidates.js.map
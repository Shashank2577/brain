...
export default defineAction({
    description: "Update recurring Dispatch dream settings without immediately running or applying a dream pass.",
    schema: z.object({
        enabled: z
            .boolean()
            .optional()
        ...
        sourceId: z
            .string()
            .optional()
            .describe("Thread debug source id. Use 'all' for every connected source."),
        sourceIds: z
...
//# sourceMappingURL=set-dream-settings.js.map
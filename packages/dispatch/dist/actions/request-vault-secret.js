...
export default defineAction({
    description: "Request access to a credential for an app. Non-admins use this to ask workspace admins to provision a secret.",
    schema: z.object({
        credentialKey: z
            .string()
...
//# sourceMappingURL=request-vault-secret.js.map